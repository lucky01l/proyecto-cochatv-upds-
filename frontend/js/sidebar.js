...
export function sidebar() {
  ...
  <a href="./index.html" menu-close class="sidebar-link">Inicio</a>
  <a href="./movie-list.html" menu-close class="sidebar-link"
    onclick='getMovieList("with_genres=", "Películas")'>Películas</a>
  <a href="./movie-list.html" menu-close class="sidebar-link"
    onclick='getMovieList("with_genres=", "Series")'>Series</a>
  <a href="./movie-list.html" menu-close class="sidebar-link"
    onclick='getMovieList("with_genres=35", "Comedia")'>Comedia</a>
</div>
